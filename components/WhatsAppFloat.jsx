...
const FALLBACK_NUMBER = '15551234567'; // fallback so button always shows; replace with your number in shop details

export default function WhatsAppFloat() {
  const { allData } = useShopData();
  // const rawNumber = allData?.shop_details?.shopcontactnumber || '';
  const rawNumber = '+919589606511';
  ...
  return (
    ...
    >
      <svg
        className="academy-whatsapp-float__icon"
        viewBox="0 0 24 24"
        fill="currentColor"
        aria-hidden
      >
