...
export default function ApplyForDemoPopup({ courses = [], onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.course_id) {
            setError('Please select a course for demo.');
            return;
        }
        setLoading(true);
        setError(null);
    ...
    const courseDisplayName = selectedCourse ? (selectedCourse.title || selectedCourse.name || selectedCourse.id) : '';
            ...
            <div className="academy-modal-overlay" onClick={onClose}>
                <div className="academy-modal academy-modal--success" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="academy-modal__content">
                        ...
                        <h2 className="academy-modal__title">Demo Request Submitted!</h2>
                        <p className="academy-modal__subtitle">You have successfully applied for a demo of <strong>{courseDisplayName}</strong>.</p>
    ...
    return (
        <div className="academy-modal-overlay" onClick={onClose}>
            <div className="academy-modal" onClick={e => e.stopPropagation()}>
                <button className="academy-modal__close" onClick={onClose}>&times;</button>
                <div className="academy-modal__content">
                    <h2 className="academy-modal__title">Apply for Demo</h2>
                    <p className="academy-modal__subtitle">Choose a course and fill in your details to request a demo.</p>
                    ...
                    <form className="academy-modal__form" onSubmit={handleSubmit}>
                        ...
                        <div className="academy-modal__form-group">
                            <label htmlFor="course_id" className="academy-modal__label">Choose course for demo <span className="required-asterisk">*</span></label>
                            <select
                                id="course_id"
                                name="course_id"
